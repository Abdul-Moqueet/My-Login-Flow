...
class LoginViewModel : ViewModel() {
    ...
    private var authState:AuthenticationState = AuthenticationState.UNAUTHENTICATED
    ...
    fun getFactToDisplay(context: Context): String {
        ...
        Log.i("#Facts", "Fun Type: ${funFactType} \n Auth State: $authState")

        //Showing Facts According to the preference...
        if (funFactType.equals(context.getString(R.string.fact_type_california)) && authState == AuthenticationState.AUTHENTICATED )
